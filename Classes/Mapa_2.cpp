...
bool Mapa_2::init()
{
    ...
    auto fondo = Sprite::create("fondo_2.png");
    ...
    //piso
    auto piso = Sprite::create("piso_3.png");
    ...
    this->schedule(CC_SCHEDULE_SELECTOR(Mapa_2::spawn_bullet_enemy), 0.5f); // Generar asteroides cada 1 segundo
    ...
    auto audio_level = AudioEngine::play2d("audio/level_2.mp3");
    ...
    listener->onKeyPressed = CC_CALLBACK_2(Mapa_2::onKeyPressed, this);
    listener->onKeyReleased = CC_CALLBACK_2(Mapa_2::onKeyReleased, this);
...
void Mapa_2::update(float delta) {
...
void Mapa_2::onKeyPressed(EventKeyboard::KeyCode keyCode, Event* event) {
...
void Mapa_2::onKeyReleased(EventKeyboard::KeyCode keyCode, Event* event) {
...
void Mapa_2::spawn_bullet_enemy(float delta) {
...
void Mapa_2::mapa_3() {
    ...
    Director::getInstance()->replaceScene(TransitionFade::create(0.1, mini_game_p2::create()));
